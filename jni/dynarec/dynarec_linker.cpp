...
void arm_mcr(u32 pc)
{
	...
	armcp15_moveARM2CP((armcp15_t*)dynarec_cpu->coproc[cpnum], dynarec_cpu->R[REG_POS(i, 12)], REG_POS(i, 16), REG_POS(i, 0), (i>>21)&0x7, (i>>5)&0x7);
...
void arm_mrc(u32 pc)
{
	...
	armcp15_moveCP2ARM((armcp15_t*)dynarec_cpu->coproc[cpnum], &dynarec_cpu->R[REG_POS(i, 12)], REG_POS(i, 16), REG_POS(i, 0), (i>>21)&0x7, (i>>5)&0x7);
