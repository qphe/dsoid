...
LOCAL_MODULE    := dsoidv7
LOCAL_ARM_MODE := arm
LOCAL_ARM_NEON:= false
LOCAL_CPPFLAGS := -fexceptions -fprefetch-loop-arrays -fvariable-expansion-in-unroller -mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a -mtune=cortex-a9
